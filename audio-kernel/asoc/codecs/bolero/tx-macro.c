...
struct tx_macro_priv {
    ...
    #ifdef VENDOR_EDIT
    /*Yuchun.Yang@PSW.MM.AudioDriver.Codec, 2020/10/27, Add for resolve glitch during amic record  , liyunfan5@huaqin.com, 2020/11/04*/
...
static void tx_macro_tx_hpf_corner_freq_callback(struct work_struct *work)
{
	...
	if (is_amic_enabled(component, hpf_work->decimator)) {
        ...
        #ifdef VENDOR_EDIT
        /*Yuchun.Yang@PSW.MM.AudioDriver.Codec, 2020/10/27, sync cocoB Add for resolve glitch during amic record, 2020/11/18 */
