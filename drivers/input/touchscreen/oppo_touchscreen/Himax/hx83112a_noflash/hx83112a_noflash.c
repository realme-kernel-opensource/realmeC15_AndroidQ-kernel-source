...
void himax_ts_diag_func(struct chip_data_hx83112b *chip_info, int32_t *mutual_data)
{
    ...
    int dsram_type = 0;
#if 0 //reserve ,pls ignore
    char write_buf[100 * 3];
...
int __maybe_unused hx83112b_tp_probe(struct spi_device *spi)
{
...
int __maybe_unused hx83112b_tp_remove(struct spi_device *spi)
{
