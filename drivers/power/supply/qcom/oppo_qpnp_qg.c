...
/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-09-11, Remove unuse battery id */
...
static int batt_id_range[TOTAL_BATTERY_NUMBER][2] =
{
	...
	//{180,350},//15K = 304mv
	#ifdef ODM_HQ_EDIT
	/* Yuzhe.Peng@ODM_HQ.CHARGE 2020/05/23 modify for rum ATL 100k(961mv) battery */
	{550,790},//68K = 707mv,100k = 961mv, change from {550,820} to {550,1100}
	//{1040,1325},
	#endif /*ODM_HQ_EDIT*/
};
...
//#ifdef ODM_WT_EDIT
	...
	/* Bin2.Zhang@ODM_WT.bsp.chg.basic, 2020-07-27, runin disable temperture protect */
...
static int oppo_get_battery_capacity(void)
{
	...
	//if (get_boot_mode() == MSM_BOOT_MODE__RECOVERY) {//debug for bring up
       //         return capacity;
       // }
		...
		count ++;
#ifndef ODM_HQ_EDIT
/* wangxianfei@BSP.CHG.Basic, 2020/06/28, Currently using qg capacity, because there are still no ready of healthd_ready */
		return DEFAULT_BATT_SOC;
#endif
	}
...
{
#ifdef ODM_WT_EDIT
	/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-28, Add for engineer mode show magicnum */
	int rc = 0;
	int temp = 0;

	rc = get_cycle_count(qpnp_gauge_ic->counter, &temp);
	return temp;
#else /* ODM_WT_EDIT */
	int batt_cc = 3500;
	return batt_cc;
...
#ifdef ODM_WT_EDIT
	/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-28, Add for engineer mode show magicnum */
	remain_capacity = 6000 * remain_capacity / 100;
#else /* ODM_WT_EDIT */
