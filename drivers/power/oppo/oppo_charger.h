...
//#ifdef ODM_WT_EDIT
	...
	int qc_9v2a_charger_hv_thr;
	int qc_9v2a_charger_recv_thr;
	int qc_9v2a_charger_lv_thr;
//#endif /* ODM_WT_EDIT */
	int vbatt_full_thr;
	int vbatt_hv_thr;
	int vfloat_step_mv;
	...
	int default_input_current_led_ma_high;
	int input_current_led_ma_high_hvdcp;
