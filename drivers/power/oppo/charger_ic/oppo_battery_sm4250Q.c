...
//#ifdef ODM_WT_EDIT
/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-05, Add for battery/bms/chg hardwareinfo. */
...
//#ifndef ODM_WT_EDIT
///* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 20200803, Add for output interrupt debug message */
...
//#ifdef ODM_WT_EDIT
	/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-09-08, Add for log output */
	if (chg->system_temp_level == chg->thermal_levels) {
		pr_info("set system_temp level %d, Stop battery charging!!!\n", chg->system_temp_level);
	} else {
		pr_info("set system_temp level %d, current:%d!\n",
...
#if 0 //ndef ODM_WT_EDIT
/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-17, Remove for usb AICL suspend config */
...
//#ifdef ODM_WT_EDIT
/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-26, Add for ARB */
...
/* Yichun.Chen  PSW.BSP.CHG  2019-04-08  for charge */
	...
	//#ifdef ODM_WT_EDIT
		/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-25, Add for ARB */
		schedule_delayed_work(&chg->arb_monitor_work, msecs_to_jiffies(ARB_DELAY_MS));
	//#endif /* ODM_WT_EDIT */
	} else {
...
//#ifdef ODM_WT_EDIT
	/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-13, Add for monitor skin/cpu temperature */
	smblib_get_iio_channel(chg, "odm_skin_temp", &chg->iio.odm_skin_temp_chan);
	smblib_get_iio_channel(chg, "odm_cpu_temp", &chg->iio.odm_cpu_temp_chan);
//#endif /* ODM_WT_EDIT */
...
#endif
//#ifdef ODM_WT_EDIT
	/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-07-27, Add start/stop charging property */
...
#endif
//#ifdef ODM_WT_EDIT
	/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-03, Add start/stop charging property */
	case POWER_SUPPLY_PROP_STOPCHARGING_TEST:
		pval.intval = 1;
		//rc = smblib_set_prop_input_suspend(chg, &pval);
		rc = vote(chg->usb_icl_votable, TEST_VOTER, pval.intval, 0);
...
//#ifdef ODM_WT_EDIT
	...
	if (rc < 0)
		dev_err(chg->dev, "Couldn't disable all jeita rc=%d\n", rc);
#endif /* CONFIG_DISABLE_TEMP_PROTECT */
//#endif /* ODM_WT_EDIT */
...
//#ifdef ODM_WT_EDIT
	/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-31, Add for don't support usb connector temperature check */
	return;
//#endif /* ODM_WT_EDIT */
	if (boot_mode == MSM_BOOT_MODE__RF || boot_mode == MSM_BOOT_MODE__WLAN){
		return;
...
//#endif
	...
	if (rc < 0) {
		...
		pr_err("oppochg_set_vbus limit = %d, pre_charger_type:%d\n", vbus, g_oppo_chip->pre_charger_type);
	}
...
//#ifdef ODM_WT_EDIT
	/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-17, Modify for S88635AA1 */
...
static int oppochg_get_ibus_slave(void)
{
	struct smb_charger *chg = NULL;
	union power_supply_propval val;
	...
	power_supply_get_property(chg->batt_psy, POWER_SUPPLY_PROP_PARALLEL_CURRENT_NOW, &val);
	return val.intval;
}
...
struct oppo_chg_operations oppochg_smb5_ops = {
	...
	.get_ibus_slave		= oppochg_get_ibus_slave,
...
//#ifdef ODM_WT_EDIT
	/* Bin2.Zhang@ODM_WT.BSP.Charger.Basic, 2020-08-17, Add for return battery present first */
