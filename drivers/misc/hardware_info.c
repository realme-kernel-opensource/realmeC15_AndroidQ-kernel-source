	...
	unsigned int cmd, unsigned long arg)
{
	...
	case HARDWARE_BT_GET:
		// #ifdef VENDOR_EDIT
		// zhangzhao@ODM_WT.CONN.WIFI, 2020/08/10,add bt info in MM
	...
	case HARDWARE_WIFI_GET:
		// #ifdef VENDOR_EDIT
		// zhangzhao@ODM_WT.CONN.WIFI, 2020/08/10,add wlan info in MM
	...
	case HARDWARE_FM_GET:
		// #ifdef VENDOR_EDIT
		// zhangzhao@ODM_WT.CONN.WIFI, 2020/08/10,add fm info in MM
